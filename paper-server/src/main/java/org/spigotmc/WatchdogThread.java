        ...
        while (!this.stopping) {
            ...
            if (this.lastTick != 0 && this.timeoutTime > 0 && WatchdogThread.hasStarted && (!server.isRunning() || (currentTime > this.lastTick + this.earlyWarningEvery && !DISABLE_WATCHDOG))) { // Paper - add property to disable
                ...
                if (isLongTimeout) {
                    ...
                    logger.log(Level.SEVERE, "The server has stopped responding! This is (probably) not a Dimigot bug."); // Dimigot
                    ...
                    logger.log(Level.SEVERE, "If you are unsure or still think this is a Dimigot bug, report it to the Dimigot project maintainers.");
                    logger.log(Level.SEVERE, "Be sure to include ALL relevant console errors and Minecraft crash reports");
                    logger.log(Level.SEVERE, "Dimigot version: " + Bukkit.getServer().getVersion());
